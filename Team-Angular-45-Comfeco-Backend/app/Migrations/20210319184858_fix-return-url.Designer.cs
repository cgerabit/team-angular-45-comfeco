...
namespace BackendComfeco.Migrations
{
    ...
    [Migration("20210319184858_fix-return-url")]
    partial class fixreturnurl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendComfeco.Models.ExternalLoginValidRedirectUrl", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Url = "http://team45.comfeco.cristiangerani.com/auth/external-signin-callback"
                        },
                        new
                        {
                            Id = 4,
                            Url = "https://team45.comfeco.cristiangerani.com/auth/external-signin-callback"
                        });
                });
            ...
            modelBuilder.Entity("BackendComfeco.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendComfeco.Models.PersistentLoginValidRedirectUrl", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Url = "https://team45.comfeco.cristiangerani.com/auth/persistent-signin-callback"
                        },
                        new
                        {
                            Id = 4,
                            Url = "http://team45.comfeco.cristiangerani.com/auth/persistent-signin-callback"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d7dd16c7-cb9e-4935-9ac9-7b71209f3729",
                            Name = "ContentCreator",
                            NormalizedName = "ContentCreator"
                        },
                        new
                        {
                            Id = "88d3be36-a8aa-422c-b6a2-99b98a042fed",
                            ConcurrencyStamp = "94587ff2-9bf1-45df-b254-cdcb0b39e586",
                            Name = "Admin",
            ...
            modelBuilder.Entity("BackendComfeco.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("BackendComfeco.Models.Group", "Group")
                        .WithMany("Users")
