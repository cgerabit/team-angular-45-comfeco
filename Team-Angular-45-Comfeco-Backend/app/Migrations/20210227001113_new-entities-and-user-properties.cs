...
{
    public partial class newentitiesanduserproperties : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserEvents", x => new { x.UserId, x.EventId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserEvents_AspNetUsers_UserId",
                        column: x => x.UserId,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "6a8af04b-0405-4cd2-bc20-d59433235153",
                column: "ConcurrencyStamp",
                value: "2ab3b05b-86c6-4a89-9baa-07975ecec906");
        }
    }
}
